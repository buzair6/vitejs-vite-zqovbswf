...
function DashboardPage({ assets = [], workOrders = [], toolBookings = [] }: DashboardPageProps) {
    ...
    // Add explicit return type ChartData for Doughnut (TS2322)
    ...
    // Open WOs by Priority
     // Add explicit return type ChartData for Pie (TS2322)
        ...
        <div className="dashboard-page">
            ...
            <section className="kpi-grid">
             ...
             <section className="dashboard-charts-grid">
                 ...
                 {/* TS2339 Fix: Ensured woTrendData has labels property by explicit type and returning [] */}
                 {woTrendData && woTrendData.labels && woTrendData.labels.length > 0 ? (
                 ...
                 {/* TS2339 Fix: Ensured woPriorityData has labels property by explicit type and returning [] */}
                  {woPriorityData && woPriorityData.labels && woPriorityData.labels.length > 0 ? (
                     <div className="chart-container">
                 ...
                 {/* Asset Status Chart */}
                  ...
                  {/* TS2339 Fix: Ensured assetStatusData has labels property by explicit type and returning [] */}
                  {assetStatusData && assetStatusData.labels && assetStatusData.labels.length > 0 ? (
                      <div className="chart-container">
                         <h3>Asset Status</h3>
                          <div style={{ position: 'relative', height: '350px', width: '100%' }}>
                 ...
                 {/* TS2339 Fix: Ensured woTypeData has labels property by explicit type and returning [] */}
                 {woTypeData && woTypeData.labels && woTypeData.labels.length > 0 ? (
                     <div className="chart-container">
